...
export default {
  ...
  data () {
    return {
      ...
      data: {
        imgSrc:require('/root/jzb/web/src/assets/logo.png'),
        nodes: [],
        links: []
      },
    names: ['结果', '权重', '功能', '层数', '神经元', '重要神经元'],
    labels: ['Result', 'Weight', 'Function', 'Layer', 'Unit','impUnit'],
    linkTypes: ['', 'weight', 'function', 'layer','unit', 'impunit']
    }
  },
  methods: {
    // 视图更新
